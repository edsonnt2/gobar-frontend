  ...
  return (
    <Container>
      <Menu>
        <li>
          <LinkMenu
            to="/business/register-product"
            selected={whoSelected === 'product' ? 1 : 0}
          >
        ...
        <li>
          <LinkMenu
            to="/business/register-table"
            selected={whoSelected === 'table' ? 1 : 0}
          >
        ...
        <li>
          <LinkMenu
            to="/business/register-ingress"
            selected={whoSelected === 'ingress' ? 1 : 0}
          >
            <GiTicket size={20} />
            Cadastrar Entrada
          </LinkMenu>
